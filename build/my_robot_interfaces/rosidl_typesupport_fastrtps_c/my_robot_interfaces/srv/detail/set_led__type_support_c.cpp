...
#include "my_robot_interfaces/srv/detail/set_led__rosidl_typesupport_fastrtps_c.h"
...
using _SetLed_Request__ros_msg_type = my_robot_interfaces__srv__SetLed_Request;
...
static size_t _SetLed_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__SetLed_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, SetLed_Request)() {
...
using _SetLed_Response__ros_msg_type = my_robot_interfaces__srv__SetLed_Response;
...
static size_t _SetLed_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__SetLed_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, SetLed_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, SetLed)() {
