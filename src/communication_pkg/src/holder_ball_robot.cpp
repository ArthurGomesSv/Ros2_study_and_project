...
public:
    HolderNode() : Node("holder_ball_robot")
    {
        ...
        ball_height_subscriber_ = this->create_subscription<std_msgs::msg::Int32>("camera/ball_height_traking",
                                                            10,std::bind(&HolderNode::callback_holder_ball_height,this,std::placeholders::_1));
        ball_height_publisher_ = this->create_publisher<std_msgs::msg::Int32>("communication/holder_ball_height_traking",10);

        ball_heigh_ref_subscriber_ = this->create_subscription<std_msgs::msg::Int32>("communication/inter_graph_ball_height_ref",
                                                            10,std::bind(&HolderNode::callback_holder_ball_height_ref,this,std::placeholders::_1));
        ball_heigh_ref_publisher_ = this->create_publisher<std_msgs::msg::Int32>("communication/holder_ball_height_ref",10);
...
private:
    ...
    std_msgs::msg::Int32 ball_heigh_;
    std_msgs::msg::Int32 ball_heigh_ref_;

    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr pwm_subscriber_;
    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr ball_height_subscriber_;
    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr ball_heigh_ref_subscriber_;
    ...
    rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr ball_heigh_ref_publisher_;
    ...
    void callback_holder_ball_height(const std_msgs::msg::Int32::SharedPtr msg)
    {
        ball_heigh_.data = msg->data;
        publisher_ball_height();
    }

    void callback_holder_ball_height_ref(const std_msgs::msg::Int32::SharedPtr msg)
    {
